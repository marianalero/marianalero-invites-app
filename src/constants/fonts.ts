...
export const fonts: InvitationFont[] = [
  ...
  { id: 2, name: "Alex Brush", fontFamily: '"Alex Brush", serif', category: "Script", mostChosen: true },
  { id: 3, name: "DM Serif Display", fontFamily: '"DM Serif Display", serif', category: "Serif" },
  { id: 4, name: "Great Vibes", fontFamily: '"Great Vibes", serif', category: "Script", mostChosen: true },
  ...
  { id: 7, name: "Parisienne", fontFamily: '"Parisienne", serif', category: "Script", mostChosen: true },
  { id: 8, name: "Pinyon Script", fontFamily: '"Pinyon Script", serif', category: "Script", mostChosen: true },
  ...
  { id: 12, name: "Southland", fontFamily: '"Southland"', category: "Script", mostChosen: true },
  { id: 13, name: "Gistesy", fontFamily: '"Gistesy"', category: "Script", mostChosen: true },

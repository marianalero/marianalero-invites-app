...
const XVRenataDemo  = () => {
  ...
  const [showLoader, setShowLoader] = useState(true);
        ...
        const eventCards: EventCardProps[] = [
            {
               ...
               textColor: TEXT_PRIMARY,
                ...
                bodyTypo: BODY_TYPO,
                fontSize:"45px",
                href: "https://maps.app.goo.gl/3taDE2Ny9Yg7cUcM9",
    ...
    const sponsors = [
        {
            name: "Pamela Garcia Rodriguez",
        
        },
        {
            name: "Hector Javier Rodriguez Garcia",
            name2: "Maria del Rosario Rodriguez Garcia",
        },
    ...
    const handleConfirmed = (name: string, confirmText: string, phoneNumber: string, totalConfirmed: string, companionNames?: string) => {
        ...
        if(confirmText == "Asistiré"){
            window.open(`https://wa.me/+52000000?text=Hola,Mi nombre es ${name}%20y%20confirmo%20mi%20asistencia%20para%20la%20Quinceañera%20%20de%20Renata.%0ANúmero de invitados:${totalConfirmed}%0AAcompañantes: ${companionNames}`, '_blank');

        }else{
            window.open(`https://wa.me/+52000000?text=Hola,%20no%20podre%20mi%20asistir%20a%20la%20Quinceañera%20de%20Renata.Mi nombre es: ${name}`, '_blank');

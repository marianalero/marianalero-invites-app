...
const WeddingSphiaLuis  = () => {
    ...
    const handleConfirmed = (name: string, confirmText: string, phoneNumber: string, totalConfirmed: string, companionNames?: string) => {
        ...
        if(confirmText == "Asistiré"){
            window.open(`https://wa.me/+526623945085?text=Hola, mi nombre es ${name}%20y%20confirmo%20mi%20asistencia%20para%20la%20boda%20%20de%20Sophia y Luis Enrique.%0ANúmero de invitados:${totalConfirmed}%0AAcompañantes: ${companionNames}`, '_blank');

        }else{
            window.open(`https://wa.me/+526623945085?text=Hola, mi nombre es ${name}%20y%20no%20podre%20asistir%20a%20la%20boda%20de%20Sophia y Luis Enrique.`, '_blank');

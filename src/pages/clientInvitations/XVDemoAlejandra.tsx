...
const XVDemoAlejandra  = () => {
    ...
    const URL_IMAGES = `${URL_REPO}xv/xv-briana/`;
        ...
        const eventCards: EventCardProps[] = [
            ...
            {
                eventName: "Recepción",
                date: new Date(2026, 3, 18, 19, 0, 0),
               textColor: TEXT_PRIMARY,
                ...
                bodyTypo: BODY_TYPO,
                fontSize:"45px",
                href: "https://maps.app.goo.gl/bqjzWXZV1FxcaHr26",
...
export default XVDemoAlejandra;

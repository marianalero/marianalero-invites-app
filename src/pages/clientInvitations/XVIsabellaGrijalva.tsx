...
export const BG_MAIN = "#FCFAF5"; // Marfil cálido - fondo principal

export const BG_SECTION = "#FFFFFF"; // Blanco - tarjetas / secciones

export const BG_ALT = "#F3F5EA"; // Pistache muy tenue - secciones alternas

export const BG_ACCENT = "#E7B8C520"; // Rosa muy tenue para bloques
...
export const PRIMARY_LIGHT = "#E4EBD9"; // Pistache claro
...
export const PINK = "#DFA6B4"; // Rosa empolvado

export const PINK_DARK = "#B96F82"; // Rosa profundo

export const PINK_LIGHT = "#F3DDE2"; // Rosa muy claro
...
export const BORDER = "#E5DED1";

export const DIVIDER = "#DED8CB";
...
export default  XVIsabellaGrijalva;

                        ...
                        <CardContent>
                            <Grid container spacing={2} display={"flex"}  alignItems={"center"} padding={2} bgcolor={props.bgColor} sx={{borderRadius:1}}>	
                                <Grid size={{xs:12,sm:12,md:12,lg:12}}  >
                                    <Typography variant='h3'  style={{color:props.color,fontSize:props.fontSize ? props.fontSize : "3rem"}} textAlign={"center"} className={props.mainTypo} >{props.eventName}</Typography>
                                </Grid>		
                                { isSmallScreen ? 
                                (
                                    <Grid size={{xs:12,sm:5,md:5,lg:5}} display="flex"  justifyContent={"center"} alignItems={"center"}>
                                        ...
                                        <Typography marginLeft={1} variant='body1'  style={{color:props.color}} textAlign={"center"} className={props.bodyTypo} >{localizedDate.format("dddd D MMMM YYYY").toLocaleUpperCase()}</Typography>
                                    </Grid>
                                )
                                :
                                (
                                    <Grid size={{xs:12,sm:5,md:5,lg:5}} display="flex"  justifyContent={"center"} alignItems={"center"}>
                                    <FontAwesomeIcon fontSize={"20px"} color={props.color} icon={faCalendarRegular} />
                                        <Typography  marginLeft={2} variant='body1' style={{color:props.color}} textAlign={"center"} className={props.bodyTypo} >{localizedDate.format("dddd D MMMM YYYY").toLocaleUpperCase()}</Typography>
                                    </Grid>
                                )
                                ...
                                <Grid size={{xs:12,sm:5,md:5,lg:5}} display="flex" justifyContent={"center"}  alignItems={"center"}>
                                    ...
                                    <Typography sx={{marginLeft:"2px"}} variant='body1' style={{color:props.color}}  textAlign={"center"} className={props.bodyTypo}>  {localizedDate.format("hh:mm A")} { localizedEndDate ? `- ${localizedEndDate.format("hh:mm A")}` : "" }</Typography>
                                </Grid>
                                )
                                :
                                (
                                      <Grid size={{xs:12,sm:5,md:5,lg:5}} display="flex"  justifyContent={"center"} alignItems={"center"}>
                                    <AccessTimeIcon style={{color:props.color}} ></AccessTimeIcon> 
                                    <Typography  marginLeft={2} variant='body1' style={{color:props.color}}  textAlign={"center"} className={props.bodyTypo}>  {localizedDate.format("hh:mm A")} { localizedEndDate ? `- ${localizedEndDate.format("hh:mm A")}` : "" }</Typography>
                                </Grid>
                                )
